...
export const defaultQuestions = [
  ...
  "Obligé de te faire tatouer un logo de marque sur le bras, tu choisis lequel ? 😏",
  "Obligé de te déguiser pour une soirée à thème, tu choisis quoi ? Les idées nulles trinquent ! 🎭",
  "Ton pire texto envoyé sous l’effet de l’alcool ? Pas de réponse = tu bois deux fois ! 🍹",
  "Balance une chanson honteuse que tu connais par cœur ! Si tout le monde la chante, c’est toi qui bois ! 🎶",
  "Premier tatouage : où et quoi ? Pas tatoué = Boisson ! 🖋️",
  "Si tu devais choisir une chanson pour draguer, laquelle ? Le moin romantique trinques ! 🎤",
  "À quand remonte ton dernier mensonge sur ton CV ? Si ça dépasse un an, tu trinques ! 💼",
  "Raconte un truc gênant que tu fais en secret. Pas de révélation = double dose ! 🤫",
  "Tu découvres que ton crush est à cette soirée, tu serai différent à quel point ? Les  acteurs trinquent ! 😳",
  "Coup de foudre à l’étranger ? Les globe-trotteurs trinquent ! ✈️",
  "Déjà planté un(e) pote pour un rencard ? Si oui, bois et demande pardon ! 😅",
  "Ton dernier achat compulsif ? Si ça dépasse 50€, à boire ! 🛒",
  "Si tu devais passer une nuit dans un endroit interdit, tu choisirais quoi ? Pas d’idée ou idée Nul = Bois ! 🚷",
  "Dernière série que tu as speedrun ? Les fans hardcore trinquent ! 📺",
  "Ton spot de rêve pour une escapade coquine ? Pas d’idée = double dose ! 🌅",
  "Si on fouille ton historique internet, on trouve quoi de louche ? Si tu veux pas repondre, c'est double dose ! 🔍",
  "Un rituel bizarre avant de dormir ? Les originaux trinquent ! 🛌",
  "Si tu devais choisir un(e) partenaire pour survivre à une apocalypse zombie, qui ici ? Tous les autres boivent ! 🧟",
  "@joueur Ta boisson préférée pour une soirée, tout ceux qui aiment pas boivent ? 🍹",
  "Ton crush de collège, si tu le recroise aujourd'hui, c'est comment ? Bois si tu préfère ne pas répondre... 💌",
  "Dernier pari stupide que tu as fait ? Si c’était hilarant, les autres trinquent ! 🎲",

  "Si tu devais vivre dans un autre pays, tu choisirais lequel ? Pas d'idée ou trop classique ? Tu bois ! 🌍",
"Dernière fois que tu as fait semblant d’aimer une soirée ? Les hypocrites trinquent ! 🥴",
"Si tu devais choisir une seule appli sur ton téléphone, laquelle tu gardes (La FunBox ???) ? Pas de réponse rapide = glou glou ! 📱",
"Ton plus gros craquage shopping ? Si tu regrettes encore, bois deux fois ! 🛍️",
"Ton emoji préféré ? Les choix éclatés trinquent ! 😂",
"Tu gagnes 1 million d’euros : premier achat ? Les rêves trop classiques boivent ! 💸",
"Déjà eu un crush sur quelqu’un totalement inattendu ? Les surprises trinquent ! 😏",
"Ton dernier mensonge pour éviter une corvée ? Pas d’idée, tu bois direct ! 🧹",
"Si tu pouvais devenir célèbre pour quelque chose, ce serait quoi ? Pas de réponse cool = double dose ! 🌟",
"Ton dernier « DM envoyé par erreur » pour prendre la tempérzature ? Les pros du malaise trinquent ! 📩",
"Si tu pouvais choisir une seule chanson pour représenter ta vie, laquelle ? Les mauvais goûts trinquent ! 🎵",
"Déjà eu un crush sur une célébrité improbable ? Si oui = qui + à boire ! 🌠",
"Ton plus gros fail culinaire ? Les amateurs de plats cramés trinquent ! 🍳",
"Si tu devais switcher de métier, tu ferais quoi ? Pas d’idée = double shot ! 💼",
"Ton pire prétexte pour esquiver une soirée ? Si c’était bidon, tu bois ! 🙈",
"Déjà stalké le profil de quelqu’un récemment ? Les espions trinquent ! 🕵️",
"Un plat que tu détestes mais que tout le monde adore ? Les rebelles trinquent ! 🍕",
"Un plat que tu adores mais que tout le monde déteste ? Les rebelles trinquent ! 🍕",
"Si tu pouvais revivre une seule journée, laquelle ce serait ? Pas de souvenir marquant = shot ! ⏳",
"Tu découvres une photo hyper compromettante de toi… Tu fais quoi ? Pas de plan = tu bois ! 📸",
"Un truc honteux que tu fais encore aujourd’hui ? Les chelous trinquent ! 🤐",

"Si tu devais passer une semaine sans téléphone, tu ferais quoi ?, Les accros trinquent ! 📵",
"Ton pire crush secret au lycée ? Si tu ne dis rien, tu bois ! 🏫",
"Dernière fois que tu as regardé une série juste pour un(e) acteur/actrice ? Les superfans trinquent ! 🌟",
"Ton plan le plus raté pour impressionner quelqu’un ? Les maladroits trinquent ! 😅",
"Si tu pouvais changer ton prénom, tu choisirais quoi ? Pas d’idée = double shot ! ✨",
"Ton dernier achat inutile sur internet ? Si tu l’as déjà oublié, bois deux fois ! 📦",
"Déjà caché un truc à tes parents en mode pro ? Les experts trinquent ! 🤐",
"Si tu devais passer 24h enfermé(e) avec une personne ici, ce serait qui ? Pas de choix = shot direct ! 🕒",
"Ton moment le plus gênant en visio ? Les pros des filtres involontaires trinquent ! 💻",
"Déjà menti à ton boss ? Si oui, à boire sans hésiter ! 👩‍💼",
"Ton pire crush sur un personnage de fiction ? Les fans assumés trinquent ! 📖",
"Ton dernier texto envoyé par erreur ? Si c’était gênant, shot obligatoire ! 📲",
"Si tu devais choisir une tenue pour un date parfait, ce serait quoi ? Pas de style = double dose ! 👗",
"Un secret sur toi que personne ici ne connaît ? Pas de révélation = à boire ! 🤫",
"Ton moment le plus awkward en soirée ? Les autres votent si c’est vraiment gênant ! 🎉",
"Déjà testé une astuce TikTok complètement ratée ? Si oui, trinque ! 🎥",
"Ton dernier message supprimé avant qu’il soit vu ? Si c’était pour éviter un malaise, bois deux fois ! 🚨",
"Ton surnom le plus bizarre ? Les pseudos éclatés trinquent ! 🐥",
"Si tu pouvais échanger ta vie avec quelqu’un ici pour une journée, ce serait qui ? Pas de réponse = double shot ! 🔄",
"Dernière fois que tu as fait semblant d’être occupé(e) pour esquiver un appel ? Les champions de l’excuse trinquent ! 📞",

"Ton dernier crush inavouable ? Pas de réponse = à boire ! 😏",
"Le lieu public le plus insolite où tu pourrais t’imaginer faire quelque chose d’interdit ? Les sages trinquent ! 🏙️",
"As-tu déjà rêvé de quelqu’un ici de manière… ambiguë ? Si oui, tu bois ! 🤭",
"Ton pire rencard qui aurait pu finir différemment ? Raconte ou trinque ! 💋",
"Déjà eu un crush sur une personne inattendue ? Les originaux trinquent ! 😳",
"Si tu pouvais embrasser une personne ici, ce serait qui ? Pas de choix = double shot ! 😘",
"Déjà reçu ou envoyé un texto un peu trop hot ? Si oui, à boire ! 📱",
"Ton scénario parfait pour un premier baiser ? Les trop timides trinquent ! 💕",
"Ton plus gros moment de gêne en parlant de quelque chose de sexy ? Raconte ou bois ! 😅",
"La personne la plus inattendue qui t’a déjà fait tourner la tête ? Pas d’histoire = shot direct ! 🌀",
"Déjà laissé un message vocal gênant après une soirée ? Les audacieux trinquent ! 🎤",
"Déjà eu un crush sur un(e) collègue ? Les pros du bureau trinquent ! 🖇️",
"Ton mot préféré pour parler d’amour ou… plus ? Si tu ne trouves pas, bois deux fois ! 💬",
"Déjà utilisé une excuse ridicule pour éviter un moment intime ? Les stratèges trinquent ! 🕵️",
"La pire phrase de drague qu’on t’ait sortie ? Partage ou bois ! 🎯",
"As-tu déjà ressenti un instant… électrique avec quelqu’un ici ? Si oui, les concernés boivent ensemble ! ⚡",
"Ton style préféré pour une soirée romantique ? Pas d’idée = double dose ! 🌹",
"Déjà été surpris(e) en train de flirter de façon un peu trop évidente ? Les coupables trinquent ! 👀",
"Si tu devais partager une nuit à l’hôtel avec quelqu’un ici, ce serait qui ? Pas de réponse = double shot ! 🏨",
"Ton crush sur une star qui te fait rêver ? Les rêveurs trinquent ! 🌟",

"As-tu déjà eu une pensée coquine en pleine réunion ou cours ? Si oui, bois pour te rattraper ! 💼",
"Ton dernier rêve un peu… spicy ? Si tu ne veux pas le dire, trinque ! 🌶️",
"Déjà pensé à quelqu’un ici dans un contexte un peu… audacieux ? Les concernés boivent ensemble ! 😏",
"Si tu devais choisir quelqu’un ici pour un dîner aux chandelles, ce serait qui ? Pas de choix = double shot ! 🍷",
"Déjà reçu un compliment un peu trop direct ? Les gênés trinquent ! 🫣",
"Ton pire moment de gêne en envoyant un message ambigu ? Raconte ou bois ! 📱",
"Le lieu le plus improbable où tu t’es déjà imaginé(e) flirter ? Pas d’idée = double dose ! 🌍",
"Déjà laissé quelqu’un lire un texto un peu trop… personnel ? Les imprudents trinquent ! 🤭",
"Ton crush le plus random ? Si c’est trop bizarre, shot direct ! 🎯",
"Déjà tenté une approche qui s’est retournée contre toi ? Les maladroits trinquent ! 😅",
"Si tu pouvais passer une soirée romantique avec une célébrité, ce serait qui ? Pas de réponse = double shot ! 🌟",
"Ton moment de flirt le plus épique ? Raconte ou bois deux fois si c’était un fiasco ! 💋",
"Ton crush de jeunesse qui te fait encore sourire ? Pas d’anecdote = à boire ! 🎓",
"Ton opinion sur les massages… avec un peu plus ? Si tu n’assumes pas, shot direct ! 👐",
"Déjà embrassé quelqu’un juste pour voir ce que ça faisait ? Les curieux trinquent ! 😘",
"Si tu pouvais lire les pensées d’une personne ici pendant 5 minutes, qui choisirais-tu ? Buvez tout les deux ! 🧠",
"Déjà eu une discussion qui a pris une tournure inattendue et gênante ? Raconte ou trinque ! 😬",
"Déjà eu un coup de foudre en soirée ? Les romantiques trinquent ! ✨",
"Ton endroit préféré pour un premier rendez-vous romantique ? Pas d’idée = double shot ! 🌹",
"Déjà écrit un message trop audacieux après un verre de trop ? Les aventuriers trinquent ! 🍷",
